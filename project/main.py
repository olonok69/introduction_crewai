...
def security_review_output_guardrail(output: Any) -> Tuple[bool, Any]:
    ...
    # Validate highest_risk matches actual highest risk
    if risk_levels_found:
        ...
        if reported_highest != actual_highest:
            return (False, "Highest risk level does not match the highest risk level in the vulnerabilities.")
